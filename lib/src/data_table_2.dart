...
class DataTable2 extends DataTable {
  DataTable2({
    ...
    this.lmRatio = 1.2,
    this.sortWidget = const Icon(Icons.arrow_upward),
    this.idealSortWidget = const Icon(Icons.sort),
